package FrameworkOfLesson4.FrameworkOfLesson4_JUnit;
		...
		for (String[] buferArry : arrayListOfTestCases)
		{
			...
			else
			{
				...
				{			
					...
					myObject2.writeExcelCellsWithSQLQueryResult(pathToTestReportFile, bufferSQLResult, sheetNumber, rowCounter); // ������� SQL ������, ����� �������� � ����� ������(����� ������, �����
					rowCounter++;																			// ���������� ������ � ���������� �������)
				}
			}
		}
